  ...
  <div class="donation-header-wrapper">
    <nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary donation-navbar">
      <div class="container aea">
        ...
        <span class="navbar-text donation-tagline d-block w-100">Juntos hacemos la diferencia</span>
        <div class="collapse navbar-collapse" id="donationNavbarDropdown">
          <ul class="navbar-nav ms-auto donation-nav-menu">
            <li class="nav-item donation-nav-item">
              <a class="nav-link active donation-nav-link" aria-current="page" href="./index.php">Inicio</a>
            </li>
            <li class="nav-item donation-nav-item">
              <a class="nav-link donation-nav-link" href="proyectos.php">Proyectos</a>
            </li>
            <li class="nav-item donation-nav-item">
